...
class AdminSignUpView(CreateView):
    ...
    def form_valid(self, form):
        ...
        return Response(get_context_data)
...
class TeamCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        team.save()
        messages.success(self.request, 'The team was created with success! ')
        return Response( team.pk)
...
# @method_decorator([login_required, hradmin_required], name='dispatch')
